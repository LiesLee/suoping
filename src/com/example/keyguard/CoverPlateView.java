...
public class CoverPlateView extends View {
	...
	public CoverPlateView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	 ...
	 * boolean onDoubleTap(MotionEvent e) boolean onDoubleTapEvent(MotionEvent
	 * e) boolean onDown(MotionEvent e) void onLongPress(MotionEvent e) boolean
	 * onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float
	 * distanceY) void onShowPress(MotionEvent e) boolean
	 * onSingleTapConfirmed(MotionEvent e) boolean onSingleTapUp(MotionEvent e)
	 */
