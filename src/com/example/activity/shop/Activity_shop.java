...
public class Activity_shop extends BaseFragmentActivity implements ShopInterface {
	...
	/** 列表 */
	/*
	 * @ViewInject(R.id.lv_shop_body) private ListView lv_shop_body;
	 */
	/** ViewPager **/
	...
	protected void initUI() {
		...
		/*
		 * bitmapUtils = new BitmapUtils(activity); adapter = new
		 * Shop_Adapter(activity, bitmapUtils);
		 */
		/*
		 * // 滑动时停止加载图片 lv_shop_body.setOnScrollListener(new
	...
	protected void initData() {
		/*
		 * for (int i = 0; i < 20; i++) { dataList.add(""); }
	...
	/**
	 * A {@link android.support.v4.app.FragmentPagerAdapter} that returns a
