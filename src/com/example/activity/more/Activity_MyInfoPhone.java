 ...
 */
public class Activity_MyInfoPhone extends BaseActivity {
	/** 标题栏 */
	...
	public static void luanch(Activity activity, String title, String hit) {
		Activity_MyInfoPhone.title = title;
		Intent intent = new Intent(activity, Activity_MyInfoPhone.class);
	...
	public String setTag() {
		// TODO Auto-generated method stub
		return Activity_MyInfoPhone.class.getSimpleName();
	}
