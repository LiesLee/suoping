...
import com.example.fragments.Fragment_APK_Management;
...
public class Activity_MyDownload extends BaseFragmentActivity implements ShopInterface {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch (position) {
			/*
			 * case 0: return Fragment_MyDownload.newInstance("1", apks);
			 */
			case 0:
				return Fragment_MyDownload.newInstance("2", apks);
			case 1:
				return Fragment_APK_Management.newInstance("3", apks);
			default:
				return Fragment_MyDownload.newInstance("2", apks);
			}
		}
