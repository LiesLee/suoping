...
public class PullToRefreshScrollView extends ScrollView {
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.view_head_refresh, null);

		arrowImageView = (ImageView) headView.findViewById(R.id.head_refresh_view_arrow);
		progressBar = (ProgressBar) headView.findViewById(R.id.head_refresh_view_progressBar);
		tipsTextview = (TextView) headView.findViewById(R.id.head_refresh_view_title);
		lastUpdatedTextView = (TextView) headView.findViewById(R.id.head_refresh_view_label);
