...
public class MyExpandableListView extends ExpandableListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		innerLayout.setLayoutParams(new LayoutParams(LinearLayout.LayoutParams.FILL_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT));
		innerLayout.setOrientation(LinearLayout.VERTICAL);
		footLayout = new LinearLayout(context);
		footLayout.setLayoutParams(new LayoutParams(LinearLayout.LayoutParams.FILL_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT));
		footLayout.setOrientation(LinearLayout.VERTICAL);
		mDownToUpAnimation = new RotateAnimation(0, -180, RotateAnimation.RELATIVE_TO_SELF, 0.5f,
		...
		mUpToDownAnimation = new RotateAnimation(-180, 0, RotateAnimation.RELATIVE_TO_SELF, 0.5f,
				RotateAnimation.RELATIVE_TO_SELF, 0.5f);
		...
		mHeadView = (LinearLayout) mLayoutInflater.inflate(R.layout.view_head_refresh, null);
		...
		mFootView = (LinearLayout) mLayoutInflater.inflate(R.layout.view_foot_load_more, null);
		...
		// View view = mLayoutInflater.inflate(R.layout.circle_list_footer,
		// null);
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		case SCROLL_STATE_TOUCH_SCROLL:
			...
			break;
		/*
		 * if(ll_popcontent.getVisibility()==0){ iv_poptop.setVisibility(8);
		 * ll_popcontent.setVisibility(8); }
		 */
		}
	}
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			mHeadViewProgressBar.setVisibility(View.GONE);
			mHeadViewArrowImg.clearAnimation();
			mHeadViewArrowImg.setImageResource(R.drawable.icon_arrow_down);
			mHeadViewTitleTv.setText("下拉刷新");
			mHeadViewLableTv.setVisibility(View.VISIBLE);

			// mHeadView.clearAnimation();
			// TranslateAnimation hideAnim = new TranslateAnimation(0, 0,0,
			// -mHeadViewHeight);
			// hideAnim.setDuration(600);
			...
			// }
			// });
			// innerLayout.setAnimation(hideAnim);
			break;
		}
	}
	...
	public void setRefleshHeadVisibility() {
		...
		// mHeadView.setAnimation(AnimationUtils.loadAnimation(context,
		// R.anim.iphone_ui_out));
		// mHeadView.clearAnimation();
		// TranslateAnimation hideAnim = new TranslateAnimation(0, 0,
		// -mHeadViewHeight, 0);
	...
	private void changeFooterViewByState() {
		...
		case RELEASE_TO_LOAD:
			...
			mFootViewTitleTv.setText("松开加载更多");
			break;
		case PULL_TO_LOAD:
			mFootViewProgressBar.setVisibility(View.GONE);
			mFootViewTitleTv.setVisibility(View.VISIBLE);
			...
			if (isBack) {
				...
				mFootViewTitleTv.setText("上拉加载更多");
			} else {
				mFootViewTitleTv.setText("上拉加载更多");
			}
			break;
		...
		case DONE:
			...
			mFootViewArrowImg.setVisibility(View.VISIBLE);
			mFootViewArrowImg.clearAnimation();
			mFootViewArrowImg.setImageResource(R.drawable.icon_arrow_up);
			mFootViewTitleTv.setText("上拉加载更多");
			// mFootViewLableTv.setVisibility(View.VISIBLE);
			break;
		}
	...
	public void setRefreshable(boolean mIsRefreshable) {
